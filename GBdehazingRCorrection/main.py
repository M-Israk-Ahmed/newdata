...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        cv2.imwrite(output_folder +'/' + prefix + '_GBDehazedRcoorectionUDCP_TM.jpg', np.uint8(transmission[:, :, 0] * 255))
        ...
        # print('sceneRadiance',sceneRadiance)
        cv2.imwrite(output_folder +'/' + prefix + 'GBDehazedRcoorectionUDCPAdaptiveMap.jpg', sceneRadiance)
